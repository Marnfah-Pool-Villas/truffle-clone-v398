  ...
  th: {
    ...
    location: {
      ...
      beachCards: {
        ...
        kata: {
          title: "หาดกะตะ",
          description: "หาดทรายทอ���คำที่บริสุทธิ์ เหมาะสำ���รับกา���โต้คลื่�� อาบแดด และสัมผัสวัฒนธรรมชายหาดไทยแท้",
      ...
      mapSection: {
        ...
        description: "ตั้งอยู่อย่างลงตัวระหว่างชายหาดที่ดีที่สุดของพัทยา เดินทางสะดวกสู่การช้อปป���้งหรู อาหารร��ดับ���รีเมียม และสนามบินนา��าชาติ"
      }
    },
    investment: {
    ...
    virtualTour: {
      ...
      features: {
        ...
        navigation: {
          ...
          description: "การเปลี่ยนพื้นที่ที่ไร้รอย��่อ"
        },
        walkthrough: {
  ...
  hi: {
    ...
    investment: {
      ...
      stability: {
        ...
        description: "���ाईलैंड का स्थिर राजनीतिक वातावरण, मजबूत पर्यटन उद्योग और दक्षिण पूर्व ���शिया ���ें रणनी��िक स्थान इसे व��वेकश������ रियल एस्टेट नि���ेशकों के लिए स्मार्ट विकल्प बनात��� है। सरकार की निवेश सम���्थक नीतियां और बुनि��ादी ढांचे ����ा विकास ��्मार्ट ��नी के अवसरों को बढ़ावा देना जारी रखता है���",
        metrics: {
          rating: {
  ...
  vi: {
    ...
    location: {
      ...
      mapSection: {
        ...
        description: "Nằm hoàn hảo giữa những bãi biển đẹp nhất Pattaya. Dễ dàng tiếp cận mua sắm cao cấp, ẩm thực tinh hoa và sân bay quốc tế."
      }
    },
    investment: {
