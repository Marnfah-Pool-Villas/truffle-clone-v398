...
export const translations: Record<Language, Translations> = {
  ...
  th: {
    ...
    properties: {
      ...
      description: "สัมผัสความหรูหราแบบเขตร้อน\nไม้���บอุ่นและหินอิตาลีเพิ่มความงาม\nมีจำนวนจำกัดตั้งแต่ ฿12.3M ถ��ง ฿23.4M",
      priceRange: "ถึง",
      villa1: {
        name: "ความเงี��บสงบ",
    ...
    amenities: {
      ...
      description: "การออกแบบระดับโลกสำหรับเจ้าขอ��บ้านที่มีรสนิยม\nทุกข้อเท็จจริงแล��ผ้าถูกคัดสรรมาอย่างละเอียด\nเพลิดเพลินกับความหร��หราที่ไร้ขีดจำกัด",
      features: {
    ...
    location: {
      title: "���ั้งอยู่ในสวรรค์",
      stats: {
        beaches: "ชายหา��บริสุทธิ์",
        restaurants: "ร้านอา��ารมิชล���น",
        amenities: "สิ่งอำนวยความสะดวกระดับหรู"
      },
      locationStats: {
        beaches: {
          title: "ชายหาดบริสุทธิ์",
          subtitle: "ไ���ฟ์สไตล์ริมทะเล"
        },
        golf: {
      ...
      mapSection: {
        title: "ท���เลที่ตั้งยุทธศาสตร์",
        description: "ตั้งอยู่อย่างลงตัวระหว่างชายหาดที่ดีที่สุดของพัทยา เดินทางสะดวกสู่การช้อปป���้งหรู อาหารระดับ���รีเมียม และสนามบินนา��าชาติ"
      }
    },
    investment: {
      ...
      benefits: {
        ...
        items: {
          residency: {
            title: "วี���่า��ทยอีลิท",
            description: "วีซ่าพำนักต่����ายุได้ 5-20 ปี ��ร้อมกา���ลงทุน"
          },
          tax: {
            title: "วางแผนภาษี",
          ...
          currency: {
            ...
            description: "เสถียรภาพเงินบาทและกา��เติบโตเศรษฐกิจภูมิภาค"
          },
          management: {
            title: "บริหารค่าเช่า",
            description: "บ��ิการบริหารและปล่อยเช่าโดยมืออ���ชีพ"
          },
          lifestyle: {
          ...
          ownership: {
            ...
            description: "โครงสร้างสั��ญา��ช่�� 90 ปี พร้���มสิทธิ��สืบทอ��"
          }
        }
      },
      stability: {
        title: "เสถียรภาพและการเติบโตเศรษฐกิจไทย",
        description: "สภาพแวดล้อมทางการเมืองที่มั่นคง อุตสาหกรรมท่องเที่ยวแข็งแกร่ง และทำเลยุทธศาสตร์ในอาเซียน ทำให้ไทยเป็นตัวเลือกที่ชาญฉลาดสำหรับ��ักลงทุนอสังหาฯ นโยบายรัฐและโค�����สร้างพื้นฐานส่งเสริมโอกาสก���รลงทุนอย่างต่อเนื่อง",
        metrics: {
          rating: {
            title: "อันดับเครดิต",
          ...
          gdp: {
            title: "GDP (2024)",
            subtitle: "เศรษ���กิจใหญ่อันดับ 2 อาเซียน"
          },
          tourists: {
            title: "นักท่องเ��ี่ยวต่อ����",
    ...
    virtualTour: {
      ...
      features: {
        ...
        walkthrough: {
          title: "การเดินชมแบบ���ิดีโอ",
          description: "ทัวร์แนะ��ำโดยมืออาชีพ"
        }
      },
      buttons: {
        pictures: "��ูปภาพ",
      ...
      villas: {
        type1: {
          name: "ว���ลล่าประเภท 1",
          description: "4 ห้องน��น | สระ��ินฟินิ��ี้ | ว���วทะเล",
          status: "เหลือ 2 หลัง",
          rooms: {
            living: "ห้องนั่งเล่น",
            master: "ห้องนอนใหญ่",
      ...
      interface: {
        ...
        startTour: "เริ��มทัวร์เสมือนจริง",
        nextRoom: "ห้องถัดไป",
    ...
    contact: {
      ...
      form: {
        ...
        placeholders: {
          ...
          villa3: "วิลลา 3",
          villa4: "วิลลา 4",
          message: "ฉันสนใจที่จะเรียนรู้เ���ิ่มเติมเกี่ยวกับ..."
        }
      }
    },
    footer: {
      exclusiveDevelopment: "การพั���นาเฉพาะ",
      whatsapp: "WhatsApp",
      wechat: "WeChat",
      line: "Line",
      copyright: "© 2025 MCLL ASIA CO."
  ...
  'zh-CN': {
    ...
    location: {
      ...
      beachCards: {
        ...
        karon: {
          title: "卡伦���滩",
          description: "三公里长的粉白色沙滩，提供宁静的��松和令人叹为观止的海洋全景。",
    ...
    investment: {
      ...
      stability: {
        title: "泰国���济稳定与增长",
        description: "泰国稳定的政治环境、强劲的旅游业和在东南亚的战略位置使其成为精明房地产投资者的明智选择。政�����亲投资政策和基础设施发展继续推动明智的资金机会。",
        metrics: {
          rating: {
            title: "信用评级",
            subtitle: "穆迪和标普稳��展望"
  ...
  'zh-TW': {
    ...
    location: {
      ...
      beachCards: {
        ...
        karon: {
          title: "卡倫海灘",
          description: "三公里長的��白色沙灘，提供寧靜的放鬆和令人嘆為觀止的海洋全景。",
  ...
  ru: {
    ...
    amenities: {
      ...
      description: "Дизайн мирового класса для вз��скательного домовладельца. Каждый факт и ткань тщательно подобраны. Наслажд��йтесь непревзойденным жизненным опытом.",
      features: {
    ...
    location: {
      ...
      beachCards: {
        ...
        kata: {
          title: "Пля�� Ката",
          description: "Нетронутый участ��к золотого песка, и��еально подходящ��й для серфинга, заг��ра и знакомства с подлинной тайской пля��ной культурой.",
          features: ["Вол��ы дл�� серфинга", "Виды заката", "Местная кухня", "Мирная атмосфера"]
        },
        karon: {
          title: "Пляж Карон",
      ...
      mapSection: {
        ...
        description: "Идеально расположен ��ежду лучшими пляжами Паттайи. Лёгкий доступ к роскошным магазинам, изысканной кухне и международному аэропорту."
      }
    },
    investment: {
      ...
      stability: {
        title: "Экономическая стабильность и ��ост Таиланда",
        description: "Стабильная политическая среда Таиланда, креп��ая туристическая индустрия и стратегическое расположение в Юго-Восточной Азии делают его умным выбором для проницательных инвесторов �� ��едвижимость. Проинвестиционная политика правительства и развитие инфра��тру��туры продолжают стимулировать возможности умных ден��г.",
        metrics: {
          rating: {
    ...
    virtualTour: {
      ...
      subtitle: "Исследуйте на��и роскошные виллы с захватывающими 360° турами",
      features: {
        views360: {
          title: "360° Обзор",
  ...
  ko: {
    ...
    location: {
      ...
      mapSection: {
        title: "전략적 ��치",
        description: "��타야 최고의 해변 사이에 완벽하게 자리합니다. 럭셔리 쇼핑과 파인 다이닝, 국제공항까지 편���하게 이동할 수 있습니다."
      }
    },
    investment: {
      title: "태국의 스마트 머니",
    ...
    investment: {
      ...
      benefits: {
        ...
        items: {
          ...
          lifestyle: {
            title: "ライフスタイルアクセス",
            description: "ラグジュアリーアメニ��ィ付き個人使用���"
          },
          ownership: {
            title: "���リーホールド所有権",
  ...
  hi: {
    ...
    amenities: {
      ...
      description: "रुचिशील घर के मालि�� के ल��ए विश्व स्तरीय ड��ज़���इन। हर तथ्य और कपड़े ���ो सावधानीपूर्वक तैयार किया गया। एक बेजोड��� ���ीवन अनुभव का आनंद लें।",
      features: {
    ...
    location: {
      ...
      beachCards: {
        patong: {
          title: "पाटोंग बीच",
          description: "फुकेत का जीव���त दिल, विश्व स्तर��य मनोरंजन, �����जन और रात्रि जीवन के साथ क्रिस्टल-स्पष्ट पानी से कुछ ही कदम दूर।",
        ...
        karon: {
          title: "कैरन बीच",
          description: "तीन कि���ोमीटर का पाउडरी सफेद र��त समुद्र तट जो शांत आराम और सांस लेन�� वाले समुद्री मनोरम दृ�����य प्रदान करता है।",
          features: ["शांत विश्राम", "प्राचीन पानी", "स्पा रिसॉर्ट्स", "प्रकृति सैर"]
        }
      },
      mapSection: {
        title: "रणनीतिक स्थान",
        description: "पटाया के बेहतरीन समुद्र तटों के बीच बिल्कुल स्थित। लग्ज़री शॉपिंग, फाइन डाइनिंग और अंतरराष्ट्रीय हवाई अड्डे तक आसान पहुँच।"
      }
    },
    investment: {
      ...
      benefits: {
        ...
        items: {
          residency: {
            ...
            description: "निवेश ��े साथ 5-20 व������षीय नवीक���णीय निवास वीज़ा"
          },
          tax: {
            title: "कर अनुकूलन",
          ...
          management: {
            title: "किराया प्रबंध��",
            description: "पेशेवर संपत्ति प���रबंधन ���र किराया सेवाएं"
          },
          lifestyle: {
      ...
      stability: {
        title: "थाईलैंड क�� आर्थिक ��्थिरत�� और विकास",
        description: "���ाईलैंड का स्थिर राजनीतिक वातावरण, मजबूत पर्यटन उद्योग और दक्षिण पूर्व ���शिया ���ें रणनी��िक स्थान इसे व��वेकशी��� रियल एस्टेट नि���ेशकों के लिए स्मार्ट विकल्प बनात��� है। सरकार की निवेश सम���्थक नीतियां और बुनि��ादी ढांचे ����ा विकास ��्मार्ट ��नी के अवसरों को बढ़ावा देना जारी रखता है���",
        metrics: {
          rating: {
    ...
    virtualTour: {
      ...
      interface: {
        selectVilla: "अपना वर्चुअल टूर शुरू ��रने के लिए एक विला चु��ें",
  ...
  ar: {
    ...
    properties: {
      ...
      villa1: {
        name: "الهدوء",
        features: "3 غرف نوم | مس��ح خاص | حدائق الزن",
      ...
      villa2: {
        ...
        description: "عمارة استو��ئية حديثة مع تشطيبات فاخرة",
        status: "2 متاح"
      },
      villa3: {
        name: "الانسجام",
    ...
    location: {
      ...
      beachCards: {
        patong: {
          title: "شاطئ بات��نغ",
          description: "القلب النابض بالحياة لفوكي�� مع ترفي�� وطعام وحياة ل��لية على مستوى عا��مي على بعد خطوات قليلة من المياه الصافية كالكري��تال.",
      ...
      mapSection: {
        ...
        description: "متمركز بشكل مثالي بين أفضل شواطئ باتايا. وصول سهل إ��ى التسو�� الفاخر وتناول الطعام الراقي والمطار الدولي."
      }
    },
    investment: {
      ...
      benefits: {
        ...
        items: {
          residency: {
            ...
            description: "تأشيرة إقامة قابلة للتجديد لمدة 5-20 سنة مع الاستثما��"
          },
          tax: {
            title: "تحسين الضرائب",
          ...
          currency: {
            title: "تنويع ا��عملة",
            description: "استقرار الباهت التاي��اندي والنمو الاقتصادي الإقليمي"
          },
          management: {
            title: "إدارة الإيجار",
    ...
    virtualTour: {
      ...
      features: {
        ...
        navigation: {
          ...
          description: "انتقال��ت مساحية ��لسة"
        },
        walkthrough: {
          title: "جولة فيديو",
  ...
  vi: {
    ...
    location: {
      ...
      beachCards: {
        ...
        kata: {
          title: "Bãi biển Kata",
          description: "Dải cát vàng nguyên sơ hoàn hảo cho lướt sóng, tắm nắng và trải nghiệm văn hóa bãi biển Th��i chính thống.",
      ...
      mapSection: {
        ...
        description: "Được định vị hoàn hảo giữa những bãi biển được khao khát nhất của Phuket với lối vào dễ dàng tới sân bay quốc tế, mua s����m xa hoa và sân golf nổi tiếng thế giới."
      }
    },
    investment: {
