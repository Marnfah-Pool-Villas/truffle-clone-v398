...
export const translations: Record<Language, Translations> = {
  ...
  th: {
    ...
    amenities: {
      ...
      description: "เพลิดเพลินกับความหรูหราไร้เทียมทาน\nทุกข้อมูลและวัสดุคัดสรรอย่างพิถีพิถัน\นดีไซน์ระดับโลกสำหรับเจ้าของบ้านผู้มีรสนิยม",
      features: {
      ...
      benefits: {
        ...
        items: {
          ...
          lifestyle: {
            ...
            description: "สิทธิ์ใช้ส่วนต���วพร้อมสิ่งอำนวยความสะดวกระดับหรู"
          },
          ownership: {
  ...
  'zh-TW': {
    ...
    location: {
      ...
      mapSection: {
        title: "戰略位置",
        description: "完美座落於芭達雅最優質的海灘之間。輕鬆前往奢華購物、精緻餐��與國際機場。"
      }
    },
    investment: {
      title: "泰國明智資金",
  ...
  ru: {
    ...
    amenities: {
      ...
      description: "Дизайн мирового класса для взыскательного домовладельца. Каждый факт и ткань тщательно подобраны. Наслажд��йтесь непревзойденным жиз��енным опытом.",
      features: {
  ...
  ko: {
    ...
    location: {
      ...
      mapSection: {
        title: "전략적 ��치",
        description: "파타야 최고의 해변 사이에 완벽하게 자리합니다. 럭셔리 쇼핑과 파인 다이닝, 국제공항까지 편���하게 이동할 수 있습니다."
      }
    },
    investment: {
      title: "태국의 스마트 머니",
  ...
  ja: {
    ...
    amenities: {
      title: "プレ���アムアメニティ",
      description: "センスの良い住宅所有者のための世界ク���スのデザイン。すべての事実と生地が慎重にキュレー��ョンされています。比類���ない生活��験をお楽しみください。",
      features: {
        pools: "イン���ィニティエッジプール",
        spa: "プライ��ートス���パビリオン",
  ...
  hi: {
    ...
    exclusive: {
      ...
      description: "पूर���ण प्रचुरता में रॉयल्टी की तरह ज���एं��� ऊर्जा के प्रवाह को बढ़ाने के लिए विशेष रूप से डिज़ाइन किया गया। ���न लोगों के ल�����ए जो बेहतर चीजों से प���यार करते हैं।",
    ...
    location: {
      ...
      beachCards: {
        patong: {
          title: "पाटोंग बीच",
          description: "���ुकेत का जीव���त दिल, विश्व स्तर��य मनोरंजन, �����जन और रात्र��� जीवन के साथ क्रिस्टल-स्पष्ट पानी से कुछ ही कदम दूर।",
        ...
        karon: {
          title: "कैरन बीच",
          description: "तीन कि���ोमीटर का पाउडरी सफेद र���� समुद��र तट जो शांत आराम और सांस लेन�� वाले समुद्री मनोरम दृ�������य प्रदान करता है।",
  ...
  ar: {
    ...
    investment: {
      ...
      stability: {
        ...
        description: "البيئة السياسية المستقرة في تايلاند وصناعة السياحة القوية والموقع الاستراتيجي في جنوب شرق آسيا تجعلها الخيار الذكي لمستثمري العقارات ��لمميزين. سيا��ات الحكومة المؤيدة للاستثمار وتطوير البنية التحتية تواصل دفع فرص الأموال الذكي��.",
        metrics: {
          rating: {
