...
export const translations: Record<Language, Translations> = {
  ...
  th: {
    ...
    hero: {
      subtitle1: "อสังหาริมทรัพย์ที่ทรงเกียรติที่สุดในพัทยา",
      subtitle2: "งานตกแต่งระดับพรีเมียมในรูปแบบไร้รอยต่อ",
      subtitle3: "ดีไซน์เหนือกาลเวลาพร้อมทิวทัศน์ที่สร้างแรงบันดาลใจ"
    },
    properties: {
      title: "ความสง่างามเหนือระดับ",
      description: "สัมผัสความหรูหราแห่งเขตร้อน\nรายละเอียดไม้โทนอุ่นและหินอิตาลี\nจำนวนจำกัดตั้งแต่ ฿10.9M ถึง ฿34.9M",
      priceRange: "",
      villa1: {
        name: "Tranquility",
      ...
      startingFrom: "เริ่มต้น��ี่",
      available: "ว่าง",
      reserved: "จองแล้ว"
    },
    amenities: {
      title: "สิ่งอำนวยความสะดวกระดับพรีเมียม",
      description: "เพลิดเพลินกับความหรูหราไร้เทียมทาน\nทุกข้อมูลและวัสดุคัดสรรอย่างพิถีพิถัน\nดีไซน์ระดับโลกสำหรับเจ้าของบ้านผู้มีรสนิยม",
      features: {
        pools: "สระว่ายน้ำขอบอินฟินิตี้",
        spa: "ศาลาสปาส่วนตัว",
    ...
    exclusive: {
      ...
      description: "สำหรับผู้ที่รักสิ่งประณีต\nรังสรรค์ด้วยความใส่ใจในรายละเอียดอย่างยิ่ง\nออกแบบเพื่อเสริมการไหลของพลังบวก",
      buttonText: "โบรชัวร์"
    },
    location: {
      ...
      stats: {
        ...
        amenities: "สิ่งอำนวยความสะดวกระดับหรูหรา"
      },
      locationStats: {
        beaches: {
          title: "ชายหาดบริสุทธิ์",
          subtitle: "ไลฟ์สไตล์ริมทะเล"
        },
        golf: {
          title: "สนามกอล์ฟชิงแชมป์",
          subtitle: "สิ่งอำนวยความสะดวกระดับโลก"
        },
        schools: {
          title: "โรงเรียนนานาชาติระดับแนวหน้า",
          subtitle: "การศึกษาชั้นนำใกล้บ้าน"
        }
      },
      beachCards: {
        patong: {
          title: "หาดป่าตอง",
          description: "หัวใจอันมีชีวิตชีวาของภูเก็ต พร้อมความบันเทิงระดับโลก ร้านอาหาร และชีวิตกลางคืน ห่างจากน้ำทะเลใสเพียงไม่กี่ก้าว",
          features: ["รีสอร์ต 5 ดาว", "บีชคลับ", "กีฬาทางน้ำ", "ศูนย์การค้า"]
        },
        kata: {
          title: "หาดกะตะ",
          description: "ชายหาดทรายทองที่บริสุทธิ์ เหมาะสำหรับโต้คลื่น อาบแดด และสัมผัสวัฒนธรรมชายหาดแบบไทยแท้",
          features: ["คลื่นสำหรับโต้คลื่น", "ชมพระอาทิตย์ตก", "อาหารท้องถิ่น", "บรรยากาศสงบ"]
        },
        karon: {
          title: "หาดกะรน",
          description: "ชายหาดทรายขาวยาวสามกิโลเมตร มอบการพักผ่อนอย่างเงียบสงบและวิวทะเลที่น่าตื่นตา",
          features: ["ที่พักเงียบสงบ", "น้ำทะเลใส", "รีสอร์ตสปา", "เส้นทางธรรมชาติ"]
        }
      },
      mapSection: {
        title: "ทำเลที่ตั้งยุทธศาสตร์",
        description: "ตั้งอยู่ระหว่างชายหาดที่ดีที่สุดของพัทยาอย่างลงตัว เดินทางสะดวกสู่แหล่งช้อปปิ้งหรู ร้านอาหารระดับพรีเมียม และสนามบินนานาชาติ"
      }
    },
    investment: {
      title: "เงินลงทุนชาญฉลาดของไทย",
      metrics: {
        roi: {
          title: "ผลตอบแทนต่อปี",
          subtitle: "ค่าเช่า + มูลค่าเพิ่ม"
        },
        yield: {
          title: "ผลตอบแทนจากค่าเช่า",
      ...
      marketAnalysis: {
        ...
        foreignInvestment: "เงินลงทุนจากต่างชาติ (2009-2025)",
        gdpGrowth: "คาดการณ์ GDP (2025)",
        chartTitle: "แนวโน้มอสังหาริมทรัพย์หรูในไทย",
        chartInsights: {
          growth: "การเติบโตตลอด 15 ปี",
          average2009: "ค่าเฉลี่ยปี 2009",
          average2024: "ค่าเฉลี่ยปี 2024"
        }
      },
      benefits: {
        title: "สิทธิประโยชน์",
        items: {
          residency: {
            title: "วีซ่าไทยอีลิท",
            description: "วีซ่าพำนัก 5-20 ปีต่ออายุได้ พร้อมการลงทุน"
          },
          tax: {
            title: "การวางแผนภาษี",
          ...
          currency: {
            title: "กระจายความเสี่ยงสกุลเงิน",
            description: "เสถียรภาพของเงินบาทและการเติบโตของเศรษฐกิจภูมิภาค"
          },
          management: {
            title: "การบริหารการเช่า",
            description: "บริการบริหารทรัพย์และปล่อยเช่าโดยมืออาชีพ"
          },
          lifestyle: {
          ...
          ownership: {
            title: "กรรมสิทธิ์ฟรีโฮลด์",
            description: "โครงสร้างสัญญาเช่า 90 ปี พร้อมสิทธิ์การสืบทอด"
          }
        }
      },
      stability: {
        title: "เสถียรภาพและการเติบโตของเศรษฐกิจไทย",
        description: "ประเทศไทยมีสภาพการเ���ืองที่มั่นคง อุตสาหกรรมท่องเที่ยวแข็งแกร่ง และตั้งอยู่ในตำแหน่งยุทธศาสตร์ของเอเชียตะวันออกเฉียงใต้ สร้างตลาดระดับโลกสำหรับนักลงทุน นโยบายส่งเสริมการลงทุนและการพัฒนาโครงสร้างพื้นฐานอย่างต่อเนื่องเปิดโอกาสให้กับเงินลงทุนที่มองการณ์ไกล",
        metrics: {
          rating: {
            title: "อันดับความน่าเชื่อถือ",
            subtitle: "มุมมองมีเสถียรภาพจาก Moody's และ S&P"
          },
          gdp: {
            title: "GDP (2024)",
            subtitle: "เศรษฐกิจใหญ่อันดับ 2 ของอาเซียน"
          },
          tourists: {
            title: "นักท่องเที่ยวต่อปี",
            subtitle: "เป้าหมายการฟื้นตัวก่อนปี 2024"
          }
        }
      }
    },
    virtualTour: {
      ...
      features: {
        views360: {
          title: "มุมมอง 360°",
          description: "ดื่มด่ำกับภาพพาโนรามาเต็มรูปแบบ"
        },
        navigation: {
          title: "การนำทางภายในห้อง",
          description: "เปลี่ยนพื้นที่อย่างต่อเนื่องไร้รอยต่อ"
        },
        walkthrough: {
          title: "วิดีโอพาชม",
          description: "ทัวร์นำชมโดยมืออาชีพ"
        }
      },
      buttons: {
        pictures: "รูปภาพ",
      ...
      villas: {
        type1: {
          name: "Villa Type 1",
          description: "4 ห้องนอน | สระอินฟินิตี้ | วิวทะเล",
          status: "ว่าง 2 หลัง",
          rooms: {
            living: "ห้องนั่งเล่น",
            master: "ห้องนอนใหญ่",
        ...
        type2: {
          name: "Villa Type 2",
          description: "5 ห้องนอน | ระเบียงสระน้ำ | สวนศักดิ์สิทธิ์",
          status: "ว่าง 1 หลัง",
          rooms: {
            living: "ห้องนั่งเล่นขนาดใหญ่",
            master: "ห้องสวีทใหญ่",
            pool: "ระเบียงสระน้ำ",
            kitchen: "ครัวกูร์เมต์",
            garden: "วิวสวน"
          }
        },
        type3: {
          ...
          status: "จองแล้ว",
          rooms: {
            living: "ห้องนั่งเล่นสไตล์เซน",
            master: "ห้องพักผ่อนใหญ่",
            pool: "สระส่���นตัว",
            kitchen: "ครัวเชฟ",
            garden: "สวนเซน"
          }
      ...
      interface: {
        selectVilla: "เลือกวิลล่าเพื่อเริ่มทัวร์เสมือนจริง",
    ...
    contact: {
      ...
      form: {
        ...
        villaOfInterest: "วิลล่าที่สนใจ *",
        message: "มีความคิดเห็นหรือคำถามหรือไม่?",
        submit: "ส่ง",
        placeholders: {
          ...
          email: "your@email.com",
          phone: "+66 77-888-9999",
          villaSelect: "เลือกวิลล่า",
          allVillas: "ทุกวิลล่า",
          villa1: "วิลล่า 1",
          villa2: "วิลล่า 2",
          villa3: "วิลล่า 3",
          villa4: "วิลล่า 4",
          message: "ฉันสนใจข้อมูลเพิ่มเติมเกี่ยวกับ..."
        }
      }
    },
    footer: {
      exclusiveDevelopment: "โครงการพิเศษ",
      whatsapp: "WhatsApp",
      wechat: "WeChat",
      line: "Line",
      copyright: "© 2025 MCLL ASIA CO."
  ...
  'zh-CN': {
    ...
    exclusive: {
      title: "定制生活方式",
      description: "在完全富足中过���皇室般的生活。专门设计以增强能量流动。��那些热爱精致事���的人。",
      buttonText: "查���宣传册"
    },
    location: {
      title: "坐落����",
      ...
      beachCards: {
        patong: {
          title: "芭东海滩",
          description: "普吉岛充��活力的心脏，拥有世界级娱乐、餐饮和夜生活，距��水晶般清澈的海水仅几步之遥。",
          features: ["五星级度假村", "海滩俱乐部", "水上运动", "购物中心"]
        },
        kata: {
          title: "卡塔海滩",
          description: "���片原始的金色沙滩，非常���合冲浪、日光浴和体验正宗的泰式海滩文化。",
          features: ["冲浪波浪", "日落美景", "当地美食", "宁静氛围"]
        },
        karon: {
          title: "卡伦���滩",
          description: "三���里长的粉白色沙滩，提供宁静的放松和令人叹为观止的海洋全景。",
          features: ["宁静度假", "纯净海水", "水疗度假村", "自然漫步"]
        }
      },
      mapSection: {
        title: "战略位置",
        description: "完美坐落于芭堤雅最优美的海滩之间。轻松前往奢侈购物��美食餐饮和国际机场。"
      }
    },
    investment: {
      title: "泰国���智资金",
      ...
      marketAnalysis: {
        ...
        foreignInvestment: "外国投资增��� (2009-2025)",
      ...
      stability: {
        title: "泰国���济稳定与增长",
        description: "泰国稳��的政治环境、强劲的旅游业和在东南亚的战略位置使其成为精明房地产投资者的明智选择。政�����亲投资政策和基础设施发展继续推动明智的资金机会。",
        metrics: {
          rating: {
            title: "信用评级",
            subtitle: "穆迪和标普稳定展望"
  ...
  'zh-TW': {
    ...
    hero: {
      subtitle1: "在芭達雅��負盛名的���區享��寧靜生活",
      subtitle2: "永恆設計、無與倫比的品質和對完美的熱情三位一體",
      subtitle3: "無���無邊泳池��高端裝飾和令人驚豔的景觀重新定義奢華"
    },
    properties: {
      title: "體驗您的至高現實",
    ...
    exclusive: {
      title: "訂製生活方式",
      description: "在完全富足中過著���室般的生活。專門設計以增強能量流動。為����熱愛精緻事物的人。",
      buttonText: "查看宣傳冊"
    },
    location: {
      title: "坐落天��",
      ...
      beachCards: {
        patong: {
          title: "芭東海��",
          description: "普吉島充滿活力的心臟，擁有世界級娛樂、餐飲和夜��活，距離水晶般清澈的海水僅幾步之遙。",
          features: ["五星級度假村", "海灘俱樂部", "水��運動", "購物中心"]
        },
        kata: {
          title: "卡塔海���",
          description: "一片原始的金色沙灘，非常適合衝浪、日光浴和體驗���宗的泰式海灘文化。",
      ...
      mapSection: {
        title: "戰略位置",
        description: "完美座落於芭達雅最優質的��灘之間。輕鬆前往奢華購物、精緻餐��與國際機場。"
      }
    },
    investment: {
      title: "泰國明智資金",
      ...
      benefits: {
        ...
        items: {
          residency: {
            title: "泰國精英居留權",
            description: "通過投資獲得5-20年可續簽居��簽證"
          },
          tax: {
            title: "稅收優化",
            description: "���合條件的外國投資者無資本利得稅"
          },
          currency: {
            title: "貨幣多元化",
            description: "泰銖穩��性和區域經��增長"
          },
          management: {
            title: "租賃管理",
      ...
      stability: {
        title: "泰國經濟穩定與增長",
        description: "泰國���定的政治環境、強勁的旅遊業和在東南亞的戰略位置使其成為精明房地產���資者的明智選擇。政府的親投���政���和基礎設��發展繼續推動明智的資金機會。",
        metrics: {
          rating: {
            title: "信用評級",
            subtitle: "穆迪和標普穩定展望"
  ...
  ru: {
    ...
    hero: {
      subtitle1: "Живите ��покойно в самом престижном райо��е Патта��и",
      subtitle2: "Троица ве��ного дизайна, непревзойденного качества и ��трасти к сов��ршенству",
      subtitle3: "Бе��шовные ба��сейны-��нфинити, премиум отделка и потрясающие ��иды, переопределяющие роскошь"
    },
    properties: {
      title: "Испытайте свою высшую реальность",
      description: "��азис тропической роскоши, воплощен��ый как частный рай в природе\nОткройте ��во�� дом в самом великолепном месте на Земле\nО��раниченная доступность от",
      priceRange: "до",
      villa1: {
        name: "Спокойствие",
        features: "4 спальни | Type 3",
        description: "",
        status: "Забронир��вано"
      },
      villa2: {
        name: "Безмятежность",
      ...
      startingFrom: "Начиная о��",
      available: "Доступно",
      reserved: "Забронирова��о"
    },
    amenities: {
      title: "Преми��м Удобства",
      description: "Дизайн мирового класса для взыскательного домовладельца. Каждый факт и ткань тщательно подобраны. Наслажд��йтесь непревзойденным жиз��енным оп��том.",
      features: {
    ...
    exclusive: {
      ...
      description: "Живите как королевска�� осо��а в полном изобилии. Специально разработано для усиления потока энерги��. Для тех, кто любит прекрасное.",
      buttonText: "Посмотреть брошюру"
    },
    location: {
      title: "Расположено в раю",
      stats: {
        beaches: "Н��тронутые пляжи",
        restaurants: "Рестораны Мишлен",
        amenities: "Роскошные удобст��а"
      },
      locationStats: {
        beaches: {
          title: "Нетронутые пляжи",
          subtitle: "При��орский образ жизни"
        },
        golf: {
      ...
      beachCards: {
        patong: {
          title: "Пляж Патонг",
          description: "��ркое сердце Пхукета с раз��лече��иями мир��вого класса, ресторан��ми и ночной жизнью в нес��ольких шагах от крист��льно чистых вод.",
          features: ["5-звездочные курорты", "Пляжные клуб��", "Водные виды спорта", "Торговые центры"]
        },
        kata: {
          title: "Пля�� Ката",
          description: "Нетронутый участ��к золотого песка, и��е��л��но подходящ��й для серфинга, заг��ра и знакомства с подлинной тайской пля��ной культурой.",
          features: ["Волны дл�� серфинга", "Виды заката", "Местная кухня", "Мирная атмос��ера"]
        },
        karon: {
          title: "Пляж Карон",
          description: "Три километра порошкообраз��ого белого песчаного пляжа, предлагающего сп��койное расслабление и захватывающие дух океанские панорамы.",
          features: ["Тихое убежище", "Чистые воды", "СПА-курорты", "Прогулки на прир��де"]
        }
      },
      mapSection: {
        title: "Стратегическое расположение",
        description: "Идеально расположен ��ежду лучшими пляжами Паттайи. Лёгкий дост��п к роскошным магазинам, изысканной кухне и между����ародному аэропорту."
      }
    },
    investment: {
      ...
      metrics: {
        ...
        yield: {
          ...
          subtitle: "Умный выбор местоположени��"
        },
        tax: {
          title: "Налог на прирост капитала",
          subtitle: "Защитите свой капита��"
        }
      },
      marketAnalysis: {
        title: "Анализ рын��а",
      ...
      benefits: {
        ...
        items: {
          residency: {
            title: "Тайская элитная рези����нция",
            description: "5-20-лет��яя возобновляемая виза ��а жительств�� с инвестициями"
          },
          tax: {
            title: "Налоговая оптимизация",
            description: "Отсутствие ��алога на прирост капитала для квалифиц���рованных иностранных инвесторов"
          },
          currency: {
            title: "Валютная диверсификация",
            description: "Стаб��льность т��йского бата и региональ����й экономический рост"
          },
          management: {
            title: "Управление арендой",
            description: "Профес��иональн��е управление недвижимостью и арендные услуги"
          },
          lifestyle: {
            title: "Доступ �� образу жизни",
            description: "Пра��а личного пользования с роскошными удобствами"
          },
          ownership: {
            title: "Собствен��ость в полном владении",
            description: "90-летние арендные структуры �� правами наследования"
          }
        }
      },
      stability: {
        title: "Экономическая стабильность и рост Таиланда",
        description: "Стабильная политическая среда Таиланда, креп������я туристическая индустрия и стратегическое расположение в Юго-Восточной Азии делают его умным выбором для проницательных и��весторов �� ��едвижимость. Проинвестиционная политика правительства и развитие инфра��тру��туры продолжают стимулировать возможности умных ден��г.",
        metrics: {
          rating: {
            title: "Кредитный рейтинг",
            subtitle: "Стабильный ��рогн��з Moody's и S&P"
          },
          gdp: {
            title: "ВВП (2024)",
            subtitle: "2-я по величине ��кономика АСЕАН"
          },
          tourists: {
    ...
    virtualTour: {
      ...
      subtitle: "Исследуйте наши роскошные виллы с зах��атывающими 360° турами",
      features: {
        views360: {
          title: "360° Обзор",
          description: "Полное панорам��ое погружение"
        },
        navigation: {
      ...
      villas: {
        ...
        type2: {
          name: "Вилла Тип 2",
          description: "5 спален | ��ерраса с бассейном | Садовое святилище",
          status: "��оступно 1",
          rooms: {
            living: "Большая гостиная",
            master: "Главный люкс",
            pool: "Терраса с бассейном",
            kitchen: "��ухня для гурманов",
            garden: "Вид на сад"
          }
        },
        type3: {
          name: "Вилла Тип 3",
          description: "3 с��альни | Частный бассейн | Дзен-сады",
      ...
      interface: {
        selectVilla: "Выбе��ите виллу для начала виртуал��ного тура",
        startTour: "��ачать виртуальный тур",
        nextRoom: "Следующая ком��ата",
        prevRoom: "Предыдущая комната",
        closeTour: "Закрыть ��ур",
        hotspots: "горячие точки"
      }
    },
    contact: {
      title: "Ваш ��астный тур по вилле",
      form: {
        firstName: "Имя *",
        lastName: "Фамилия *",
        email: "Адрес эл��ктронной почты *",
        phone: "Номер телефона *",
        villaOfInterest: "Ин��ересующая вилла *",
        message: "��омментарии или вопросы?",
        ...
        placeholders: {
          ...
          villa3: "Вилла 3",
          villa4: "Вилла 4",
          message: "Я заинтересован узнать ��ольше о..."
        }
      }
    },
    footer: {
  ...
  ko: {
    ...
    hero: {
      subtitle1: "파���야에서 가장 권위 있는 지���에서 평화롭게 살아���세요",
      subtitle2: "시대를 초월한 디자인, 비�� 데 없는 품질, 완벽에 대한 열정의 삼위일체",
    ...
    amenities: {
      title: "프리미엄 편의시설",
      description: "취향 있는 주택 소유자를 위한 ���계적 수���의 디자인. 모든 사실과 직물이 신중하게 ���레��션됩니다. 비할 데 없는 생활 경험을 즐기세요.",
      features: {
        pools: "인피니티 엣지 ���",
        spa: "전용 스파 파빌리온",
        concierge: "24시간 컨시어지",
    ...
    exclusive: {
      title: "맞춤형 라이프스타일",
      description: "완전한 풍요 속에서 왕족처럼 살아보세요. 에너지 흐름을 향상시키기 위해 특별히 설계되었습��다. 더 좋은 것을 사랑하는 사람들을 위해.",
      buttonText: "브로슈어 보기"
    },
    location: {
      title: "낙원에 위치",
      ...
      beachCards: {
        patong: {
          title: "파통 비치",
          description: "수정처럼 맑은 바닷물에서 몇 걸음 떨어진 세계적 수준의 엔터테인먼트, 다이닝, 나��트���이프가 있는 ���켓의 활기찬 심장부.",
          features: ["5성급 리조트", "비치 클럽", "수상 스포츠", "쇼��� 센터"]
        },
        kata: {
          title: "���타 비치",
        ...
        karon: {
          title: "카론 비치",
          description: "고요한 휴식과 ��막히는 바다 파노라마를 ��공하는 3킬로미터의 가루 같은 하얀 모래 해변.",
          features: ["조용한 휴양지", "원시 바다", "스파 리조트", "자연 산��"]
        }
      },
      mapSection: {
        title: "전략적 ��치",
        description: "파타야 최고의 해변 사이에 완벽하게 자리합니다. 럭셔리 쇼핑과 파인 다이닝, 국제공항까지 ������하게 이동할 수 있습니다."
      }
    },
    investment: {
      title: "태국의 스마트 머니",
      ...
      benefits: {
        ...
        items: {
          residency: {
            title: "태국 엘���트 거주권",
            description: "투자를 통한 5-20년 갱신 가�����한 거주 ����자"
          },
          tax: {
            title: "세금 최적화",
            description: "자격을 갖춘 외���인 투자자에 대한 양도소득세 없음"
          },
          currency: {
            title: "통화 �������",
      ...
      stability: {
        title: "태국 경제 ��정성 및 성장",
        description: "태국의 안정적인 정치 환경, ��고한 관�� 산업, 동��아시아에서의 전략적 위치로 인해 안목 있는 부동산 투자자들에게 현명한 선택이 됩니다. ��부의 친투자 정책과 인프라 개발��� 계속해서 스마트 머니 기회를 이끌고 있습니다.",
        metrics: {
          rating: {
            title: "����� 등급",
            subtitle: "무디스 & S&P 안정적 ���망"
          },
          gdp: {
            title: "GDP (2024)",
            subtitle: "아세안 2위 경제"
    ...
    virtualTour: {
      ...
      villas: {
        ...
        type2: {
          name: "빌라 타입 2",
          description: "침��� 5개 | 풀 테라스 | 가든 생추어리",
          status: "1채 판매 중",
          rooms: {
            living: "그랜드 리빙",
            master: "마스터 스위트",
  ...
  ja: {
    ...
    hero: {
      subtitle1: "パタヤで最も���威ある邸宅で平穏に暮らす",
      subtitle2: "時代を��越し����デザイン、比類なき品質、完璧への情熱の三位一体",
      subtitle3: "シ���ムレスなインフィニテ�����ール、プレミアム��上げ、ラグジュアリーを再定義する��晴らしい景色"
    },
    properties: {
      title: "最高の現実を体���してください",
      description: "熱帯の豪華さのオアシス、自然の中の私的楽園として現れる\n地球上で最も素晴らしい場所に��なたの家を発見してください\n限定販売、価格",
      priceRange: "から",
      villa1: {
        name: "静寂",
    ...
    amenities: {
      title: "プレ���アムアメニティ",
      description: "��ンスの良い住宅所有者のための世界ク���スのデザイン。すべての事実と生地が慎重にキュレー��ョンされています。比類���ない生活��験をお楽しみください。",
      features: {
        pools: "イン���ィニティエッジプール",
        spa: "プライ��ートス���パビリオン",
    ...
    exclusive: {
      title: "オーダーメイドライフス��イル",
      description: "����全な豊かさ�����で王族のように生活してください。エネルギーの流れ��向上させるために特別に��計されています。より良いものを愛する人々のために。",
    ...
    location: {
      ...
      stats: {
        ...
        amenities: "ラグジュアリーアメニ����ィ"
      },
      locationStats: {
        beaches: {
          title: "原始的なビーチ",
          subtitle: "シーサイドライフスタイ��"
        },
        golf: {
          title: "チャンピオ�����シップゴルフコース",
          subtitle: "世界クラスの施設"
        },
        schools: {
          title: "トップレ��ルの国際学校",
      ...
      beachCards: {
        patong: {
          title: "パトンビーチ",
          description: "水�����のように澄んだ海から数歩の距離にある���界クラスのエンターテイメント、ダ��ニング、ナイトライフを備えたプーケットの活気ある中心部。",
          features: ["5つ星リゾート", "ビーチクラブ", "ウ��ータースポーツ", "ショッピングセンター"]
        },
        kata: {
          title: "カタビーチ",
          description: "サーフィン、日光浴、本格的なタイのビーチ文化を体験する���に最適な原始的な黄金の砂浜。",
          features: ["サ��フィンの波", "夕日の景色", "地元料理", "平和な雰囲気"]
        },
        karon: {
          title: "カロ���ビーチ",
          description: "静かなリラクゼーションと息をのむような海のパノラマを提供する3キロメートルの粉��ような白��砂��。",
          features: ["静かなリトリート", "���始的な海", "スパリゾート", "自然散策"]
        }
      },
      mapSection: {
        title: "戦略的立地",
        description: "パタヤで最も魅力���なビーチの間という絶好のロケーション。ラグジュアリー���ショ���ピングと極上のダイニング、国際空港へもスムーズにアクセスできます。"
      }
    },
    investment: {
      title: "��イのスマートマネー",
      ...
      marketAnalysis: {
        title: "市場分析",
        luxuryGrowth: "��グジュアリ��不動産成長 (2009-2025)",
        foreignInvestment: "外国投資増加 (2009-2025)",
        gdpGrowth: "GDP���長予測 (2025)",
        chartTitle: "タイのラグジュ����リ���不動産トレンド",
        chartInsights: {
          growth: "15年成長",
          average2009: "2009年平均",
          average2024: "2024年平均"
      ...
      benefits: {
        ...
        items: {
          ...
          ownership: {
            title: "���リーホールド所有権",
            description: "相続権付き90��リース構造"
          }
        }
      },
      stability: {
        title: "タイの経済安定性と成長",
        description: "タ��の安定した政��環境、堅固な観光産業、東南アジアでの戦略的立地により、眼識のある不��産投資家にとって����マートな選択となっています。政府の親���資政策とインフラ開���がスマート���ネーの機会��継続的に推進しています。",
        metrics: {
          rating: {
            title: "��用格付け",
    ...
    virtualTour: {
      ...
      features: {
        ...
        navigation: {
          title: "ルームナビゲ���ション",
          description: "シームレ��な空間移動"
        },
        walkthrough: {
          title: "ビ��オウォークスルー",
          description: "プロフ���ッショナルガイドツアー"
        }
      },
      buttons: {
        pictures: "写真",
      ...
      villas: {
        type1: {
          name: "ヴ��ラタイプ1",
          description: "4ベッドルーム | インフィニ��ィプール | オーシャンビュ���",
          status: "2戸販売���",
          rooms: {
            living: "リビングルーム",
            master: "マスターベッドルーム",
        ...
        type3: {
          name: "ヴィラタイプ3",
          description: "3ベッド��ーム | プライベートプー��� | 禅庭園",
          status: "予約済み",
          rooms: {
            living: "禅リビング",
            master: "マスターリトリート",
      ...
      interface: {
        selectVilla: "バーチャルツアーを開始するヴィラを選��",
  ...
  hi: {
    ...
    hero: {
      subtitle1: "पट्टाया की सबसे ���्रति��्ठित संपत��ति में श����ंति से र��ें",
      subtitle2: "क���लातीत डिज़ाइन, अतुलनीय गुणवत्ता और पूर्णता के ल��ए ज��नून की त्रिमूर्ति",
      subtitle3: "निर्बाध अनंत पूल, प्री��ियम फिनिश और आश्चर्यजनक ����ृश्य जो लक्जरी को फिर से परिभाषित करते हैं"
    },
    properties: {
      title: "अपनी सर्वोच्च वास्तविकता का अनुभव ��रें",
      description: "उ��्णकटिबंधीय ऐश्वर्�� का मरुद्यान, ��्रकृति में निजी स्वर्ग के रूप में ���्��कट\nपृथ्वी के सबसे महान स्थ����न पर अपना घर खोजें\nसीमित उपलब्धत���",
      priceRange: "से",
      villa1: {
        name: "शांति",
    ...
    amenities: {
      ...
      description: "रुचिशील घर के मालि�� के ल��ए विश्व स्तरीय ड��ज़���इन। ह��� तथ्य और कपड़े ���ो स���वधानीपूर्वक तैयार किया गया। एक बेजोड��� ���ीवन अनुभव का आनंद ले���।",
      features: {
    ...
    exclusive: {
      title: "बेस्पोक ��ीवनशैली",
      description: "पूर���ण प्रचुरता में रॉयल्टी की तरह ज���एं��� ऊर्जा के प्रवाह को बढ़ाने के लिए विशेष रूप से डिज़ाइन किया गया। ���न लोगों के ल�����ए जो बेहतर चीजों से प���यार करत��� हैं।",
      buttonText: "ब्रोशर देखें"
    },
    location: {
      title: "स्वर्ग में स्थित",
      stats: {
        beaches: "प्���ा�����न समुद्र तट",
        restaurants: "मिशेलिन रेस्टो��ेंट",
        amenities: "लक्जरी �����ुविधाएं"
      },
      locationStats: {
        beaches: {
          title: "प्राच���न समुद्र तट",
          subtitle: "समुद्रतट��य जीवनशैली"
        },
        golf: {
          title: "चैम्पियनशिप गोल्��� कोर्स",
          subtitle: "विश्व स्तरीय सु���िधाएं"
        },
        schools: {
      ...
      beachCards: {
        patong: {
          title: "पाटोंग बीच",
          description: "���ुकेत का जीव���त दिल, विश्व स्तर��य म���ोरंजन, �����जन और रात्र��� जीवन के साथ क्रिस्टल-स्पष्ट पानी से कुछ ही कदम दूर।",
          features: ["5-सितारा र��सॉर्�����स", "बीच क्लब", "जल खेल", "��ॉपिंग सेंटर"]
        },
        kata: {
          title: "काता बी���",
          description: "स���नहरी रेत का ए�� प्रा���ीन खंड जो सर्���िंग, धूप सेंकने और प्रामाणिक थाई समुद्र तट संस्कृति ��ा अनुभव करने के ल��ए एकदम सही है।",
          features: ["सर्फिंग तरंगें", "सूर्यास्त द��श्य", "स्थानीय व्यंजन", "शांतिपूर्�� वातावर���"]
        },
        karon: {
          title: "कैरन बीच",
          description: "तीन कि���ोमीटर का पाउडरी सफेद र���� समुद��र तट जो शांत आराम और सा��स लेन�� वाले समुद्री मनोरम दृ�������य प्रदान करता है।",
          features: ["शांत विश्राम", "प्राचीन पानी", "स्प�� रिसॉर्���्स", "प्रकृति सैर"]
        }
      },
      mapSection: {
        title: "रणनीतिक स्थान",
        description: "पटाया के बेहतरीन समुद्र तटो��� के बीच ब��ल्कुल स्थ���त। लग्ज़री शॉपिंग, फाइन डाइनिंग और अंतरराष्ट्रीय हवाई अड्डे तक आसान पहुँच।"
      }
    },
    investment: {
      ...
      metrics: {
        roi: {
          title: "��ार्षिक ROI",
          subtitle: "क����राया + मूल्य वृद��धि"
        },
        yield: {
          title: "किराय��� यील्ड",
          subtitle: "स्मार्ट स्थ��न चुनाव"
        },
        tax: {
          title: "पू��जीग����� ल��भ कर",
      ...
      marketAnalysis: {
        title: "बाजार विश्ल��षण",
        luxuryGrowth: "लक्जरी संप���्���ि वृद���धि (2009-2025)",
        foreignInvestment: "व���देशी निवेश वृद्धि (2009-2025)",
        gdpGrowth: "जीडीपी वृद्धि ��्रक्षेपण (2025)",
        chartTitle: "थाई���ैंड लक्जरी रियल एस्टेट ट��रेंड्स",
        chartInsights: {
          growth: "15-वर��षीय वृद्धि",
          average2009: "2009 औसत",
          average2024: "2024 औ���त"
        }
      },
      benefits: {
        title: "लाभ",
        items: {
          residency: {
            ...
            description: "निवेश ��े साथ 5-20 वर���षीय नवीक���णीय निवास वीज़ा"
          },
          tax: {
            title: "कर अनुकूलन",
            description: "योग्य ��िदेशी �����िवेशकों के लिए कोई पूंजीगत लाभ कर नहीं"
          },
          currency: {
            title: "मुद्रा विविधीकरण",
            description: "थाई बाह�� स्थिर��ा औ��� क्षेत्रीय आर्��िक विकास"
          },
          management: {
            title: "किराया प्रबंध��",
            description: "��ेशेवर संपत्ति ������रबंधन ���र कि��ाया सेवाएं"
          },
          lifestyle: {
            title: "जीवनशैली पहुंच",
            description: "लक्जरी सुविधाओं ��े ���ाथ व्���क्तिगत उपयोग अधिकार"
          },
          ownership: {
            title: "म��क्त भूम�� स्वाम��त्व",
            description: "विरासत ���ध���कारों के साथ 90-���र्ष��य पट्टा ���ंरचना"
          }
        }
      },
      stability: {
        title: "थाईलैंड क�� आर्थिक स्थि��त�� और विकास",
        description: "���ाईलैंड का स्थिर राजनीतिक वातावरण, मजबूत पर्यटन उद्योग और ���क्षिण पूर्व ���शिया ���ें रणनी��िक स्थान इसे व��वेकश������ रियल एस्टेट नि���ेशकों के लिए स्मार्ट विकल्प बनात��� है। सरकार की निवेश सम���्थक नीतिय���ं और बुनि�����दी ढांचे ����ा विकास ��्मार्ट ��नी के अवसरों को बढ़ावा दे���ा जारी र���ता है���",
        metrics: {
          rating: {
            title: "क्रेडिट रेटिंग",
            subtitle: "���ूडीज़ और एसएंडपी स्थिर आउटल�����क"
          },
          gdp: {
            title: "जीडी��ी (2024)",
            subtitle: "आ��ि��ान की दूसर��� सब���े बड़ी अर्थव्यव���्था"
          },
          tourists: {
    ...
    virtualTour: {
      title: "वर्चुअल ��िला अनुभव",
      subtitle: "ह���ारे लक्जरी विला को इमर्सिव 360° टू��� के साथ एक्सप्लोर करें",
      features: {
        views360: {
          title: "360�� दृश्य",
          description: "संपूर्ण पैनोरमिक व���सर��जन"
        },
        navigation: {
          title: "कमरा नेव��गेशन",
          description: "निर्बाध स्था��� संक्रमण"
        },
        walkthrough: {
          title: "वीडियो वॉकथ्रू",
          description: "प��शेवर गाइडेड टूर"
        }
      },
      buttons: {
        pictures: "तस्वीरें",
      ...
      villas: {
        ...
        type2: {
          name: "विला टाइप 2",
          description: "5 बेडरूम | ���ूल ट���रेस | गार्डन अभयारण्य",
          status: "1 उपलब्ध",
          rooms: {
      ...
      interface: {
        selectVilla: "अपना वर्चुअल टूर शुरू ��रने के लिए एक विला ���ु��ें",
        startTour: "वर्चुअ�� टूर शुरू करें",
        nextRoom: "अगल�� क��रा",
        prevRoom: "पिछला कमरा",
    ...
    contact: {
      ...
      form: {
        ...
        placeholders: {
          ...
          email: "your@email.com",
          phone: "+66 77-888-9999",
          villaSelect: "एक व��ला चुनें",
          allVillas: "सभी",
          villa1: "विला 1",
          villa2: "विला 2",
          villa3: "���िला 3",
          villa4: "विला 4",
          message: "मुझे इसके बारे मे��� और जानने में �����चि है..."
        }
      }
    },
    footer: {
      exclusiveDevelopment: "वि���ेष विकास",
      whatsapp: "WhatsApp",
      wechat: "WeChat",
      line: "Line",
      copyright: "© 2025 MCLL ASIA CO."
    ...
    location: {
      ...
      locationStats: {
        beaches: {
          ...
          subtitle: "Estilo de vida junto al mar"
        },
        golf: {
      ...
      mapSection: {
        ...
        description: "Perfectamente situado entre las mejores playas de Pattaya. Acceso sencillo a las compras de lujo, la alta gastronomía y un aeropuerto internacional."
      }
    },
    investment: {
      ...
      benefits: {
        ...
        items: {
          ...
          currency: {
            title: "Diversificaci��n de Moneda",
  ...
  fr: {
    ...
    hero: {
      ...
      subtitle2: "Une trinité de design intemporel, qualit�� inégalée et passion pour la perfection",
      subtitle3: "Piscines à débordement parfaites, finitions premium et vues époustouflantes qui redéfinissent le luxe"
    },
    properties: {
      title: "Vivez votre plus haute r��alité",
    ...
    location: {
      ...
      locationStats: {
        beaches: {
          ...
          subtitle: "Style de vie en bord de mer"
        },
        golf: {
      ...
      mapSection: {
        ...
        description: "Parfaitement situé entre les plus belles plages de Pattaya. Accès facile aux boutiques de luxe, à la gastronomie raffinée et à un aéroport international."
      }
    },
    investment: {
      ...
      benefits: {
        ...
        items: {
          ...
          currency: {
            title: "Diversification Mon��taire",
  ...
  ar: {
    ...
    hero: {
      subtitle1: "عيش بسلام في أرق�� عقار في باتايا",
      subtitle2: "ثالوث ��ن التصميم ا����خالد والجودة الفريدة والشغف بالكمال",
      subtitle3: "برك لا متناهية سلسة وتشطيبات فاخرة وم��اظر مذهلة تعيد تعريف الرفاهية"
    },
    properties: {
      title: "اختبر أعلى واقع لديك",
      description: "تجسيد للجنة الاستوائية؛ واحتك الخاصة من الثر��ء. اكتشف م��زلك في أعظم مكان على الأرض. توافر محدود من",
      priceRange: "إلى",
      villa1: {
        name: "الهدوء",
        features: "3 غرف نوم | مسبح خاص | حدائق الزن",
        description: "رفاهية بسيط�� مع ��ناصر خشبية دافئة",
        status: "محجوز"
      },
      villa2: {
        name: "الصفاء",
        features: "4 غرف نوم | مسبح لا متناهي | إطلالة على المحيط",
        description: "عمارة استو��ئي�� حديثة مع تشطيبات فاخرة",
        status: "2 متاح"
      },
      villa3: {
        name: "الانسجام",
        features: "5 غرف نوم | شرفة المسبح | ملاذ الحديق��",
    ...
    amenities: {
      ...
      features: {
        ...
        spa: "أج��حة سبا خاصة",
        concierge: "بوا�� 24/7",
        gardens: "حدائق استوائ��ة"
      }
    },
    exclusive: {
      title: "نمط حياة مخصص",
      description: "عيش كالملوك في وفرة تامة. مصمم خصيصاً لتعزيز تدفق الطاقة. لأولئ�� الذين يحبون الأشياء الجميلة.",
    ...
    location: {
      ...
      locationStats: {
        beaches: {
          title: "شواطئ نقية",
          subtitle: "أسلوب ��ياة على شاطئ البحر"
        },
        golf: {
          title: "ملاعب غولف البطولة",
          subtitle: "مرافق عالمي�� المستوى"
        },
        schools: {
          title: "مدارس دولية من الدرجة الأولى",
          subtitle: "تعليم ا��نخبة القريب"
        }
      },
      beachCards: {
        patong: {
          title: "شاطئ بات��نغ",
          description: "القلب النابض بالحياة لفوكي�� مع ترفي�� وطعام وحياة ليلية على مستوى عا����مي على بعد خطوات قليلة من المياه الصافية كالكري��تال.",
          features: ["منتجعات 5 نجوم", "نوادي شاطئية", "ريا���ات مائية", "مراكز تسوق"]
        },
        kata: {
          title: "شاطئ كاتا",
          description: "امتداد نقي من ال��مال ��لذهبية مثالي لركوب الأ��واج والاستحمام الشمسي وتجربة ثقافة الشاطئ التايلاندية ��لأصيلة.",
          features: ["أمواج ركو�� الأمواج", "مناظر الغروب", "مأكولات محل��ة", "جو هادئ"]
        },
        karon: {
          title: "شاطئ كارون",
          description: "ثلاثة كيلومترات م�� شاطئ الرمال البيضاء الناعمة التي تقدم ��سترخاء هادئ ومناظر بحرية خلابة.",
          features: ["ملاذ هادئ", "مياه نقية", "منتجعات سبا", "نزها�� طبيعية"]
        }
      },
      mapSection: {
    ...
    investment: {
      title: "الأموال الذكية في تاي��اند",
      metrics: {
        roi: {
          title: "عائد الاستثما�� السنوي",
      ...
      benefits: {
        ...
        items: {
          ...
          tax: {
            title: "تحسين الضرائب",
            description: "لا توجد ضريبة أرباح رأس المال للمستثمر��ن الأجانب المؤهلين"
          },
          currency: {
            title: "تنويع ا��عملة",
            description: "استقرار الباهت ال��اي��اندي والنمو الاقتصادي الإقليمي"
          },
          management: {
            title: "إدارة الإيجار",
          ...
          ownership: {
            title: "ملكية حرة",
            description: "ه��اكل إيجا�� 90 سنة مع حقوق الوراثة"
          }
        }
      },
      stability: {
        title: "الاستقرار والنمو الاقتصادي في ��ايلاند",
        description: "البيئة السياسية المستقرة في تايلاند وصناعة السياحة القوية والموقع الاستراتيجي في جنوب شرق آسيا تجعلها الخيار الذكي ل��ستثمري العقارات ��لمميزين. سيا��ات الحكومة المؤيدة للاستثمار وتطوير البنية التحتية تواصل دفع فرص الأموال الذكي��.",
        metrics: {
          rating: {
            title: "التصنيف الائت��اني",
            subtitle: "نظرة مستقرة من موديز و����س آ��د بي"
          },
          gdp: {
            title: "الناتج المحلي الإجمالي (2024)",
            subtitle: "ثا��ي أكبر اقتصاد في آسيان"
          },
          tourists: {
            title: "السياح السنويون",
            subtitle: "هدف الانتعاش ما ��بل 2024"
          }
        }
      }
    },
    virtualTour: {
      title: "تجربة الفيل���� الافترا��ية",
      ...
      villas: {
        type1: {
          name: "فيلا النوع 1",
          description: "4 غرف ��وم | مسبح لا متناهي | إطلالة على ��لمحيط",
          status: "2 م��اح",
          rooms: {
            living: "غرفة المعيشة",
            master: "غرفة النوم ال��ئيسية",
            pool: "مسبح لا متناهي",
            kitchen: "المطبخ",
            terrace: "التراس"
          }
        ...
        type2: {
          name: "فيلا النوع 2",
          description: "5 غرف نوم | شرفة المسبح | ملاذ ا��حديقة",
          status: "1 متاح",
          rooms: {
            living: "معيشة كبيرة",
            master: "جناح رئيسي",
      ...
      interface: {
        selectVilla: "اختر فيلا ل��دء جولتك الافتراضية",
    ...
    contact: {
      ...
      form: {
        ...
        placeholders: {
          ...
          villa3: "فيلا 3",
          villa4: "فيلا 4",
          message: "أنا مهتم بمعرفة المزيد ���ن..."
        }
      }
    },
    footer: {
  ...
  ms: {
    ...
    location: {
      ...
      mapSection: {
        ...
        description: "Terletak sempurna di antara pantai terbaik Pattaya. Akses mudah ke membeli-belah mewah, sajian fine dining dan lapangan terbang antarabangsa."
      }
    },
    investment: {
  ...
  vi: {
    ...
    hero: {
      ...
      subtitle3: "Hồ bơi vô cực liền mạch, hoàn thiện cao cấp và cảnh quan tuyệt ��ẹp định nghĩa lại sự xa hoa"
    },
    properties: {
      title: "Trải nghiệm thực tế cao nhất của bạn",
      description: "Hiện thân c��a thiên đường nhiệt đới; ốc đ��o xa hoa riêng c���a bạn. Kh��m phá ngôi nhà của bạn tại nơi tuyệt vời nhất trên Trái đất. Có sẵn giới hạn t���",
      priceRange: "đến",
      villa1: {
        name: "Thanh Tịnh",
      ...
      villa2: {
        ...
        description: "Kiến trúc nhiệt đới hiện đại với hoàn thi��n cao cấp",
        status: "2 Có sẵn"
      },
      villa3: {
        name: "Hài Hòa",
        features: "5 Phòng ngủ | Sân thượng h�� bơi | Khu vườn thiêng",
        description: "Thiết kế tinh tế với điểm nhấn đá tự nhiên",
        status: "1 Có sẵn"
      },
      startingFrom: "Bắt đ���u từ",
      available: "Có sẵn",
      reserved: "Đã đặt"
    },
    amenities: {
      title: "Tiện ích Cao cấp",
      description: "Thiết k��� đẳng cấp thế giới cho chủ nhà có gu. Mọi sự thật và chất liệu được tuyển chọn cẩn thận. Tận hưởng trải nghiệm sống không gì sánh đư����c.",
      features: {
    ...
    location: {
      ...
      beachCards: {
        patong: {
          ...
          description: "Trái tim sôi động của Phuket với giải trí, ẩm thực và cuộc s��ng về đêm đẳng cấp thế giới chỉ vài bước từ vùng nước trong vắt như pha lê.",
          features: ["Resort 5 sao", "Club bãi biển", "Thể thao nước", "Trung tâm mua sắm"]
        },
        kata: {
          title: "Bãi biển Kata",
          description: "Dải cát vàng nguyên sơ hoàn hảo cho lướt sóng, tắm nắng và trải nghiệm văn hóa bãi bi���n Thái chính thống.",
        ...
        karon: {
          ...
          features: ["Nơi ngh�� dưỡng yên t��nh", "Nước nguyên sơ", "Resort spa", "Đi bộ trong tự nhiên"]
        }
      },
      mapSection: {
        title: "Vị trí Chiến lược",
        description: "Nằm hoàn hảo giữa những bãi biển đẹp nhất Pattaya. Dễ dàng tiếp cận mua s��m cao cấp, ẩm th���c tinh hoa và sân bay quốc tế."
      }
    },
    investment: {
      ...
      benefits: {
        ...
        items: {
          ...
          tax: {
            ...
            description: "Không có thu�� lãi vốn cho nhà đầu tư nước ngoài đủ điều kiện"
          },
          currency: {
          ...
          management: {
            ...
            description: "Quản lý bất ��ộng sản chuyên nghiệp và dịch vụ cho thuê"
          },
          lifestyle: {
      ...
      stability: {
        title: "���n định và Tăng trưởng Kinh tế Thái Lan",
        description: "Môi trường chính trị ổn định c���a Th����i Lan, ngành du lịch mạnh mẽ và vị trí chiến lược ở Đông Nam Á khiến nó trở thành lựa chọn thông minh cho các nhà đầu tư bất động sản sành sỏi. Các chính sách ủng h�� đầu tư của chính phủ và phát triển cơ sở hạ tầng tiếp tục thúc đẩy các cơ hội tiền thông minh.",
        metrics: {
          rating: {
          ...
          tourists: {
            ...
            subtitle: "Mục tiêu phục h��i trước 2024"
          }
        }
      }
    },
    virtualTour: {
      ...
      subtitle: "Khám phá những villa xa hoa của chúng tôi với tour 360° nh���p vai",
      features: {
        views360: {
          title: "Góc nhìn 360°",
        ...
        navigation: {
          ...
          description: "Chuy���n đổi không gian mượt mà"
        },
        walkthrough: {
      ...
      interface: {
        selectVilla: "Ch��n một villa để bắt đầu tour ảo của bạn",
