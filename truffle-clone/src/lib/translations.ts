...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    investment: {
      ...
      stability: {
        ...
        description: "Thailand's stable political environment, robust tourism industry, and strategic location in Southeast Asia make it the smart choice for discerning real estate investors. The government's pro-investment policies and infrastructure development continue to drive smart money opportunities.",
        metrics: {
          rating: {
            title: "Credit Rating",
  ...
  th: {
    ...
    exclusive: {
      ...
      description: "ความใส่ใจในรายละเอียดอย่างมหาศาล - ออกแบบเพื่อคุณค่าทางสุนทรียศาสตร์อย่างแท��จริง\nออกแบบเพื่อเสริมการไหลของพลังงานเชิงบวก\nสำหรับผู้ที่รักสิ่งประณีต",
    ...
    location: {
      ...
      beachCards: {
        ...
        kata: {
          ...
          features: ["คลื่นโต้คลื่น", "วิวพระอาทิตย์ตก", "อาหารท้องถิ่น", "บรรยากาศสงบ"]
        },
        karon: {
          title: "หาดกะรน",
          description: "ชายหาดทรายขาวยาว 3 กิโลเมตร มอบความผ่อนคลายและวิ���ทะเลที่สวยงาม",
    ...
    investment: {
      ...
      benefits: {
        ...
        items: {
          ...
          tax: {
            title: "วางแผนภาษี",
            description: "ไม่มีภาษีกำไรจากทุนสำหรับนักลงทุนต่���งชาติที่เข้าเงื่อนไข"
          },
          currency: {
          ...
          ownership: {
            ...
            description: "โครงสร้างสัญญา��ช่า 90 ปี พร้อมสิทธิ์สืบทอด"
          }
        }
      },
      stability: {
        title: "เสถียรภาพและการเติบโตเศรษฐกิจไทย",
        description: "สภาพแวดล���อมทางการเมืองที่มั่นคง อุตสาหกรรมท่องเที่ยวแข็งแกร่ง และทำเลยุทธศาสตร์ในอาเซียน ทำให้ไทยเป็นตัวเลือกที่ชาญฉลาดสำหรับนักลงทุนอสังหาฯ นโยบายรัฐและโครงสร้างพื้นฐานส่งเสริมโอกาสการลงทุนอย่างต่อเนื่อง",
        metrics: {
          rating: {
            title: "อันดับเครดิต",
          ...
          tourists: {
            ...
            subtitle: "เป้าหมายฟื้นตัวก่อนปี 2024"
          }
        }
      }
    },
    virtualTour: {
      ...
      subtitle: "สำรว��วิลล่าหรูของเราผ่านทัวร์ 360° สุดสมจริง",
      features: {
        views360: {
          title: "มุมมอง 360°",
      ...
      villas: {
        type1: {
          name: "วิลล่าประเภท 1",
          description: "4 ห้องนอน | สระ��ินฟินิตี้ | วิวทะเล",
          status: "เหลือ 2 หลัง",
          rooms: {
            living: "ห้องนั่งเล่น",
            master: "ห้องนอนใหญ่",
  ...
  'zh-CN': {
    ...
    location: {
      ...
      mapSection: {
        title: "战略位置",
        description: "完美位于普吉岛最令人向往的海滩之间，便于前往国际机场、奢侈品购物和世界知名高尔夫球��。"
      }
    },
    investment: {
      title: "泰国明智资金",
      ...
      benefits: {
        ...
        items: {
          ...
          tax: {
            title: "税收优化",
            description: "符合条件的外国投资者无资本利得税"
          },
          currency: {
            title: "货币多元化",
            description: "泰铢稳定性和区域经济增长"
          },
          management: {
            title: "租赁管理",
  ...
  'zh-TW': {
    ...
    virtualTour: {
      title: "虛擬別墅體驗",
      subtitle: "通過沉浸式360°遊覽探索我們的豪華別墅",
      features: {
        views360: {
          title: "360° 視角",
          description: "完整全景沉浸體驗"
        },
        navigation: {
          title: "房間導航",
          description: "無縫空間轉換"
  ...
  ru: {
    ...
    exclusive: {
      title: "Индивидуальный образ жизни",
      description: "Живите как королевская особа в полном изобилии. Специально разработано для усиления потока энергии. Для тех, кто любит прекрасное.",
    ...
    location: {
      ...
      beachCards: {
        patong: {
          title: "Пляж Патонг",
          description: "Яркое сердце Пхукета с развлечениями мирового класса, ресторанами и ночной жизнью в нескольких шагах от крист��льно чистых вод.",
        ...
        karon: {
          ...
          features: ["Тихое убежище", "Чистые воды", "СПА-курорты", "Прогулки на природе"]
        }
      },
      mapSection: {
    ...
    investment: {
      ...
      marketAnalysis: {
        ...
        gdpGrowth: "Прогноз роста ВВП (2025)",
      ...
      benefits: {
        ...
        items: {
          ...
          currency: {
            ...
            description: "Стабильность тайского бата и региональный экономический рост"
          },
          management: {
            title: "Управление арендой",
            description: "Профессиональное управление недвижимостью и арендные услуги"
          },
          lifestyle: {
            title: "Доступ к образу жизни",
            description: "Права личного пользования с роскошными удобствами"
          },
          ownership: {
            title: "Со��ственность в полном владении",
      ...
      stability: {
        ...
        description: "Стабильная политическая среда Таиланда, крепкая туристическая индустрия и стратегическое расположение в Юго-Восточной Азии делают его умным выбором для проницательных инвесторов в недвижимость. Проинвестиционная политика правительства и развитие инфраструктуры продолжают стимулировать возможности умных денег.",
        metrics: {
          rating: {
    ...
    contact: {
      ...
      form: {
        ...
        placeholders: {
          ...
          villa3: "Вилла 3",
          villa4: "Вилла 4",
          message: "Я заинт��ресован узнать больше о..."
        }
      }
    },
    footer: {
  ...
  ko: {
    ...
    hero: {
      subtitle1: "파타야에서 가장 권위 있는 지역에서 평화롭게 살아보세요",
      subtitle2: "시대를 초월한 디자인, 비할 데 없는 품질, 완벽에 대한 열정의 삼위일체",
      subtitle3: "매끄러운 인피니티 풀, 프리미엄 마감재, 럭셔리를 재정의하는 놀라운 전망"
    },
    properties: {
    ...
    amenities: {
      title: "프리미엄 편의시설",
      description: "취향 있는 주택 소유자를 위한 세계적 수준의 디자인. 모든 사실과 직물이 신중하게 큐레이션됩니다. 비할 데 없는 생활 경험을 즐기세요.",
      features: {
        pools: "인피니티 엣지 풀",
        spa: "전용 스파 파빌리온",
        concierge: "24시간 컨시어지",
    ...
    location: {
      ...
      beachCards: {
        patong: {
          title: "파통 비치",
          description: "수정처럼 맑은 바닷물에서 몇 걸음 떨어진 세계적 수준의 엔터테인먼트, 다이닝, 나이트���이프가 있는 푸켓의 활기찬 심장부.",
          features: ["5성급 리조트", "비치 클럽", "수상 스포츠", "쇼핑 센터"]
        },
        kata: {
          title: "카타 비치",
          description: "서핑, 일광욕, 정통 태국 해변 문화를 경험하기에 완벽한 원시 황금 모래 해변.",
          features: ["서핑 파도", "일몰 경치", "현지 요리", "평화로운 분위기"]
        },
        karon: {
          title: "카론 비치",
    ...
    investment: {
      ...
      stability: {
        ...
        description: "태국의 안정적인 정치 환경, 견고한 관광 산업, 동남아시아에서의 전략적 위치로 인해 안목 있는 부동산 투자자들에게 현명한 선택이 됩니다. 정부의 친투자 정책과 인프라 개발이 계속해서 스마트 머니 기회를 이끌고 있습니다.",
        metrics: {
          rating: {
            title: "신용 등급",
    ...
    virtualTour: {
      title: "가상 빌라 체험",
      subtitle: "몰입형 360° 투어로 럭셔리 빌라��� 탐험하세요",
      features: {
        views360: {
          title: "360° 전망",
      ...
      interface: {
        selectVilla: "가상 투어를 시작할 빌라를 선택하세요",
        startTour: "가상 투어 시작",
        nextRoom: "다음 방",
        prevRoom: "이전 방",
        closeTour: "투어 닫기",
  ...
  ja: {
    ...
    hero: {
      ...
      subtitle3: "シームレスなインフィニティプール、プレミアム仕上げ、ラグジュアリーを再定義する素晴らしい景色"
    },
    properties: {
    ...
    exclusive: {
      ...
      description: "完全な豊かさ��中で王族のように生活してください。エネルギーの流れを向上させるために特別に設計されています。より良いものを愛する人々のために。",
      buttonText: "パ��フレットを見る"
    },
    location: {
      title: "パラダイスに位置",
      stats: {
      ...
      beachCards: {
        patong: {
          title: "パトンビーチ",
          description: "水晶のように澄んだ海から数歩の距離にある世界クラスのエンターテイメント、ダイニング、ナイトライフを備えたプーケットの活気ある中心部。",
          features: ["5つ星リゾート", "ビーチクラブ", "ウォータースポーツ", "ショッピングセンター"]
        },
        kata: {
          title: "カタビーチ",
          description: "サーフィン、日光浴、本格的なタイのビーチ��化を体験するのに最適な原始的な黄金の砂浜。",
      ...
      mapSection: {
        title: "戦略的立地",
        description: "プーケットで最も人気のビーチの間に完璧に位置し、国際空港、ラグジュアリーショッピング、世界的に有名なゴルフコースに簡単にアクセスできます。"
      }
    },
    investment: {
      title: "タイのスマートマネー",
      ...
      benefits: {
        ...
        items: {
          ...
          currency: {
            title: "通貨分散",
            description: "タイバーツの安定性と地域経済成長"
          },
          management: {
            title: "賃貸管理",
            description: "プロフェッショナル不動産管理と賃貸サービス"
          },
          lifestyle: {
            title: "ライフスタイルアクセス",
            description: "ラグジュアリーアメニティ付��個人使用権"
          },
          ownership: {
            title: "フリーホールド所有権",
      ...
      stability: {
        title: "タイの経済安定性と成長",
        description: "タイの安定した政治環境、堅固な観光産業、東南アジアでの戦略的立地により、眼識のある不動産投資家にとってスマートな選択となっています。政府の親投資政策とインフラ開発がスマートマネーの機会を継続的に推進しています。",
        metrics: {
          rating: {
            title: "信用格付け",
    ...
    virtualTour: {
      ...
      villas: {
        ...
        type2: {
          name: "ヴィラタイプ2",
          description: "5ベッドルーム | プールテラス | ガーデンサンクチュアリ",
          status: "1戸販売中",
          rooms: {
            living: "グランドリビング",
            master: "マスタースイート",
  ...
  hi: {
    ...
    hero: {
      subtitle1: "पट्टाया की सबसे प्रतिष्ठित संपत्ति में शांति से रहें",
      subtitle2: "कालातीत डिज़ाइन, अतुलनीय गुणवत्ता और पूर्णता के लिए जुनून की त्रिमूर्ति",
    ...
    amenities: {
      title: "प्रीमियम सु���िधाएं",
      description: "रुचिशील घर के मालिक के लिए विश्व स्तरीय डिज़ाइन। हर तथ्य और कपड़े को सावधानीपूर्वक तैयार किया गया। एक बेजोड़ जीवन अनुभव का आनंद लें।",
      features: {
    ...
    exclusive: {
      ...
      description: "पूर्ण प्रचुरता में रॉयल्टी की तरह जीएं। ऊर्जा के प्रवाह को बढ़ाने के लिए विशेष रूप से डिज़ाइन किया गया। उन लोगों के ल���ए जो बेहतर चीजों से प्यार करते हैं।",
    ...
    location: {
      ...
      locationStats: {
        ...
        schools: {
          title: "शीर्ष स्तर के अंतर्राष्ट्रीय स्कूल",
      ...
      beachCards: {
        patong: {
          title: "पाटोंग बीच",
          description: "फुकेत का जीवंत दिल, विश्व स्तरीय मनोरंजन, भोजन और रात्रि जीवन के साथ क्रिस्टल-स्पष्ट पानी से कुछ ही कदम दूर।",
          features: ["5-सितार�� रिसॉर्ट्स", "बीच क्लब", "जल खेल", "शॉपिंग सेंटर"]
        },
        kata: {
          title: "काता बीच",
          ...
          features: ["सर्फिंग तरंगें", "सूर्यास्त दृश्य", "स्थानीय व्यंजन", "शांतिपूर्ण वातावरण"]
        },
        karon: {
          title: "कैरन बीच",
      ...
      mapSection: {
        title: "रणनीतिक स्थान",
        description: "अंतर्राष्ट्रीय हवाई अड्डे, लक्जरी शॉपिंग और विश्व प्रसिद्ध गोल्फ कोर्स के लिए आसान पहुंच के साथ फुकेत के सबसे प्रतिष्ठित समुद्र तटों के बीच पूरी तरह से स्थित।"
      }
    },
    investment: {
      ...
      marketAnalysis: {
        ...
        luxuryGrowth: "लक्जरी संपत्���ि वृद्धि (2009-2025)",
        foreignInvestment: "विदेशी निवेश वृद्धि (2009-2025)",
        gdpGrowth: "जीडीपी वृद्धि प्रक्षेपण (2025)",
      ...
      benefits: {
        ...
        items: {
          residency: {
            ...
            description: "निवेश के साथ 5-20 वर्षीय नवीकरणीय निवास वीज़ा"
          },
          tax: {
            title: "कर अनुकूलन",
          ...
          currency: {
            ...
            description: "थाई बाहत स्थिरता और क्षेत्रीय आर्थ��क विकास"
          },
          management: {
            title: "किराया प्रबंधन",
            description: "पेशेवर संपत्ति प्रबंधन और किराया सेवाएं"
          },
          lifestyle: {
          ...
          ownership: {
            title: "मुक्त भूमि स्वामित्व",
            description: "विरासत अधिकारों के साथ 90-वर्षीय पट्टा संरचना"
          }
        }
      },
      stability: {
        title: "थाईलैंड की आर्थिक स्थिरता और विकास",
    ...
    virtualTour: {
      ...
      subtitle: "हमारे लक्जरी विला को इमर्सिव 360° टूर के साथ एक्सप्लोर करें",
      features: {
        views360: {
          title: "360° ���ृश्य",
      ...
      interface: {
        selectVilla: "अपना वर्चुअल टूर शुरू करने के लिए एक विला चुनें",
  ...
  es: {
    ...
    hero: {
      ...
      subtitle2: "Una trinidad de diseño atemporal, calidad inigualable y pasión por la perfección",
  ...
  ar: {
    ...
    hero: {
      ...
      subtitle2: "ثالوث من التصميم الخالد والجودة الفريدة والشغف بالكمال",
      subtitle3: "برك لا متناهية سلسة وتشطيبات فاخرة ومناظر مذهلة تعيد تعريف الرفاهية"
    },
    properties: {
      title: "اختبر أعلى واقع لديك",
      description: "تجسيد للجنة الاستوائية؛ واحتك الخاصة من الثراء. اكتشف منزلك في أعظم مكان على الأرض. توافر محدود من",
      priceRange: "إلى",
      villa1: {
        name: "الهدوء",
    ...
    location: {
      ...
      beachCards: {
        ...
        kata: {
          title: "شاطئ كاتا",
          description: "امتداد نقي من الرمال الذهبية مثالي لركوب الأمواج والاستحمام الشمسي وتجربة ثقافة الشاطئ التايلاندية الأصيلة.",
      ...
      mapSection: {
        ...
        description: "موضوع بشكل مثالي بين أكثر شواطئ فوكيت المرغوبة مع سهولة الوصول إلى المطار الدولي والتسوق الفاخر وملاعب الغولف المشهورة عالمياً."
      }
    },
    investment: {
      ...
      marketAnalysis: {
        ...
        chartTitle: "اتجاهات العقارات الفاخ��ة في تايلاند",
        chartInsights: {
          growth: "نمو 15 سنة",
      ...
      benefits: {
        ...
        items: {
          ...
          lifestyle: {
            ...
            description: "حقوق الاستخدام الشخصي مع وسائل الراحة الفاخرة"
          },
          ownership: {
            title: "ملكية حرة",
    ...
    virtualTour: {
      ...
      features: {
        ...
        navigation: {
          ...
          description: "انتقالات مساحية سلسة"
        },
        walkthrough: {
          title: "جولة فيديو",
  ...
  vi: {
    ...
    properties: {
      ...
      description: "Hiện thân của thiên đường nhiệt đới; ốc đảo xa hoa riêng của bạn. Kh��m phá ngôi nhà của bạn tại nơi tuyệt vời nhất trên Trái đất. Có sẵn giới hạn từ",
      priceRange: "đến",
      villa1: {
        name: "Thanh Tịnh",
    ...
    amenities: {
      ...
      description: "Thi��t kế đẳng cấp thế giới cho chủ nhà có gu. Mọi sự thật và chất liệu được tuyển chọn cẩn thận. Tận hưởng trải nghiệm sống không gì sánh được.",
      features: {
    ...
    location: {
      ...
      beachCards: {
        ...
        kata: {
          ...
          features: ["Sóng lướt", "Cảnh hoàng hôn", "Ẩm thực địa phương", "Không gian yên bình"]
        },
        karon: {
          ...
          features: ["Nơi nghỉ dưỡng yên tĩnh", "Nước nguyên sơ", "Resort spa", "Đi bộ trong tự nhiên"]
        }
      },
      mapSection: {
    ...
    investment: {
      ...
      stability: {
        ...
        description: "Môi trường chính trị ổn định của Thái Lan, ngành du lịch mạnh mẽ và vị trí chiến lư��c ở Đông Nam Á khiến nó trở thành lựa chọn thông minh cho các nhà đầu tư bất động sản sành sỏi. Các chính sách ủng hộ đầu tư của chính phủ và phát triển cơ sở hạ tầng tiếp tục thúc đẩy các cơ hội tiền thông minh.",
        metrics: {
          rating: {
