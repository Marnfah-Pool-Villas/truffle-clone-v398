...
export default function ExclusiveSection() {
  const t = useT()
  return (
    <div className="max-w-7xl mx-auto py-6 sm:py-20 px-4 sm:px-6 flex flex-col-reverse lg:flex-row items-center justify-between gap-y-6 sm:gap-y-8 lg:gap-y-10 lg:gap-x-12">
